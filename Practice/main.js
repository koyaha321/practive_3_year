...
// показувати поточний час по секундах
...
/*функції для отримання годин, хвилин, секунд,
   ранку або вечора, додати нуль, встановити час і звук будильника, очистити будильник
*/
...
//коли час будильника дорівнює поточному часу, відтворити звук
	var h2 = document.getElementById('clock');

/*функція для обчислення поточного часу
потім порівняйте його з часом будильника та відтворіть звук, коли вони рівні
*/
